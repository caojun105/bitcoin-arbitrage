...
##broker_thrift = thriftpy.load(os.path.join( "C:","Users","juncao","Documents","GitHub","bitcoin-arbitrage","arbitrage", "lib", "broker.thrift" ), module_name="broker_thrift")
broker_thrift = thriftpy.load(r"C:\Users\juncao\Documents\GitHub\bitcoin-arbitrage\arbitrage\lib\broker.thrift", module_name="broker_thrift")
